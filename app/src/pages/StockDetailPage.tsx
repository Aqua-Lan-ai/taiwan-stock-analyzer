      ...
      <main className="max-w-3xl mx-auto px-6 py-8 space-y-6">
        ...
        {!isETF && (
          <>
            {stock.financials && (
              <Section title="估價區間">
                <ValuationCard cashDividend={stock.financials.cashDividend} eps={stock.financials.eps} bps={stock.financials.bps ?? []} price={stock.price} subType={stock.subType ?? null} splitCutoffYear={stock.financials.splitCutoffYear} />
              </Section>
            )}
